...
nodist npm 7.20.3
```
> もし上記のコマンドでエラーが発生する場合は、`nodist npm match`と言うコマンドを入力してみてから、もう一度`nodist npm 7.20.3`を実行してみてください。
...
![React starter](https://raw.githubusercontent.com/Hiro-mackay/react-bootcamp/bootcamp-1/assets/react_starter.png)
...
![change text](https://raw.githubusercontent.com/Hiro-mackay/react-bootcamp/master/assets/change_text.png)
...
![ignore app component](https://raw.githubusercontent.com/Hiro-mackay/react-bootcamp/bootcamp-1/assets/ignore_app_component.png)
