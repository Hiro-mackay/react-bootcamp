...
`;
export type InsertVideoMutationFn = Apollo.MutationFunction<
  InsertVideoMutation,
  InsertVideoMutationVariables
>;
 ...
 * });
 */
export function useInsertVideoMutation(
  baseOptions?: Apollo.MutationHookOptions<
    InsertVideoMutation,
    InsertVideoMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<InsertVideoMutation, InsertVideoMutationVariables>(
    InsertVideoDocument,
    options
  );
}
export type InsertVideoMutationHookResult = ReturnType<
  typeof useInsertVideoMutation
>;
export type InsertVideoMutationResult =
  Apollo.MutationResult<InsertVideoMutation>;
export type InsertVideoMutationOptions = Apollo.BaseMutationOptions<
  InsertVideoMutation,
  InsertVideoMutationVariables
>;
